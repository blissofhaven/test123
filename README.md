...
Блок ядра и ТТ проверен на коммите `1ce00d1`: **3643 теста прошли**.
[Отчёт и границы проверки](docs/work-verification/fault-branches-ct-2026-09-09.md).
Следующий согласованный блок интерфейса — [выбор проекта и КЗ в точке](docs/point-fault-workflow.md):
обычный запуск показывает окно выбора, открытие схемы не запускает полный расчёт.
Результаты его отдельной проверки публикуются в [отчёте](docs/work-verification/startup-point-fault-2026-09-09.md).
